...
**Key Decisions:**
- [x] One subscription per tenant environment
- [x] Overlapping CIDRs (namespace isolation handles it)
- [x] Peering for cross-tenant communication to shared services
- [x] Quota enforcement per subscription
...
**Key Decisions:**
- [x] Separate Network Provider instance per region
- [x] Same CIDR ranges (namespace + region isolation)
- [x] Global peering for cross-region communication
- [x] Regional failover (global LB routes to healthy region)
...
**Benefits:**
- [x] Hub provides shared services (DNS, logging, etc.)
- [x] Spokes isolated from each other
- [x] Easy to add new spokes
...
- [x] Plan IP ranges before deployment
- [x] Use namespace isolation for multi-tenancy
- [x] Implement network segmentation (tiers, subnets)
- [x] Define NSG rules before deploying apps
- [x] Monitor capacity trends (scale proactively)
- [x] Test DR procedures regularly
- [x] Document architecture decisions
- [x] Use cross-cluster failover
